const questions = [ //inside an array, has many objects, each object has 2 properties, each property has a string.
...
// let a = [{"a": "b"},{"c": "d"}];
// console.log(a[0].a); =========> that is how we get triviaQuestion.question in the trivia.js.